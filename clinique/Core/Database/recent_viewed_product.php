...
class recent_viewed_product extends  Table
{
    protected static $table = 'recent_viewed_product';
    ...
    public static function searchType($nbreParPage=null,$pageCourante=null,$user_id=null,$product_id=null,$debut=null,$fin=nul){
