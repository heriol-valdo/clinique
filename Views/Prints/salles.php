...
<div id="page-wrap">
    ...
    <table id="items">
        ...
        foreach ($items as $item) {
            ...
            echo
                '<tr>
                    <td class="text-center">'.StringHelper::isEmpty($item->nom).'</td>
                    <td class="text-center">'.thousand($item->prix).'</td>
                    <td class="text-center">'.StringHelper::isEmpty($item->created_at).'</td>
                </tr>
                ';
