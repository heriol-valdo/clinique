...
App::setTitle("Patients");
App::setNavigation("Patients");
...
App::addScript('assets/js/admins_patients.js',true);
?>
<div class="row">
    <div class="col-md-12">
        <div class="panel panel-dark">
            <div class="panel-heading">
                ...
                <div class="panel-control">
                    <?php if(Privilege::canView(Privilege::$eshopProductAdd,$user->privilege)){ ?>
                        <a href="javascript:void(0);" data-toggle="tooltip" class="new" data-original-title="Nouveau patient">
                    ...
                    <a href="<?= App::url('admins/patients') ?>" data-toggle="tooltip" class="panel-reload" data-original-title="Rafraichir">
            ...
            <div class="panel-body">
                <div class="row m-t-sm">
                    <div class="col-md-12">
                        <form action="<?= App::url('admins/patients') ?>" method="get">
                            <div class="row">
