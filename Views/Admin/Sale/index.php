...
App::addScript('assets/js/sale.js',true);
?>
<div class="row">
    <div class="col-md-12">
        <div class="panel panel-dark">
            <div class="panel-heading">
                <h5 class="panel-title">
                    SalLe <small>(<?= thousand($nbre->Total); ?>)</small>
                </h5>
                <div class="panel-control">
                    <?php if(Privilege::canView(Privilege::$eshopProductAdd,$user->privilege)){ ?>
                        <a href="javascript:void(0);" data-toggle="tooltip" class="new" data-original-title="Nouveelle salle">
                    ...
                    <a href="<?= App::url('sale') ?>" data-toggle="tooltip" class="panel-reload" data-original-title="Rafraichir">
            ...
            <div class="panel-body">
                <div class="row m-t-sm">
                    <div class="col-md-12">
                        <form action="<?= App::url('sale') ?>" method="get">
                            <div class="row">
            ...
            <form action="<?= App::url('produits/save') ?>" id="newForm" method="post" enctype="multipart/form-data">
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 form-group">
                            <label for="slug">Etat <b>*</b></label>
                            <input type="text" class="form-control" id="slug" name="slug" placeholder="etat" required>
                        </div>
