...
App::setTitle("Projets de $affilie->username");
App::setNavigation("Projets de $affilie->username");
...
App::setBreadcumb('<li><a href="javascript:void(0);" onclick="history.go(-1);return false;">Affiliés</a></li><li class="active">Projets</li>');
?>
<div class="row">
    <div class="col-md-12">
        <div class="panel panel-dark">
            <div class="panel-heading">
                <h5 class="panel-title">
                    <?= "Projets de $affilie->username <small>(".thousand($nbre->Total).")</small>" ?>
                </h5>
                <div class="panel-control">
                    ...
                    <a href="<?= App::url('affilies/projects?id='.$_GET['id']) ?>" data-toggle="tooltip" class="panel-reload" data-original-title="Rafraichir">
            ...
            <div class="panel-body">
                <div class="row m-t-sm">
                    <div class="col-md-12">
                        <form action="<?= App::url('affilies/projects') ?>" method="get">
                        ...
                        <div class="table-responsive project-stats">
                            <table class="table table-striped">
                                ...
                                if(!empty($projects)){
                                    ...
                                    echo '<tr><td colspan="5" class="text-danger text-center">Aucun projet trouvé...</td></tr>';
                                }
                                ?>
                                </tbody>
                                <?php
