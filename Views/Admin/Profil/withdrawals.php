...
App::setNavigation("Demandes de retrait de $affilie->username");
App::setTitle("Demandes de retrait de $affilie->username");
App::addScript('assets/js/transaction.js',true);
App::setBreadcumb('<li><a href="javascript:void(0);" onclick="history.go(-1);return false;">Affiliés</a></li><li class="active">Demandes de retrait</li>');
?>
<div class="row">
    <div class="col-md-12">
        <div class="panel panel-dark">
            <div class="panel-heading">
                <h5 class="panel-title">
                    <?= "Demandes de retrait de $affilie->username <small>(".thousand($nbre->Total).")</small>" ?>
                </h5>
                <div class="panel-control">
                    ...
                    <a href="<?= App::url('users/withdrawals?id='.$_GET['id']) ?>" data-toggle="tooltip" class="panel-reload" data-original-title="Rafraichir">
            ...
            <div class="panel-body">
                <div class="row m-t-sm">
                    <div class="col-md-12">
                        <form action="<?= App::url('users/withdrawals') ?>" method="get">
                        ...
                        <div class="table-responsive project-stats">
                            <table class="table table-striped">
                                ...
                                if(!empty($items)){
                                    ...
                                    echo '<tr><td colspan="4" class="text-danger text-center">Aucune demande trouvée...</td></tr>';
                                }
                                ?>
                                </tbody>
                                <?php
