...
App::setTitle("Personnel");
App::setNavigation("Personnel");
...
App::addScript('assets/js/admins_personnel.js',true);
?>
<div class="row">
    <div class="col-md-12">
        <div class="panel panel-dark">
            <div class="panel-heading">
                <h5 class="panel-title">
                    Personnel <small>(<?= thousand($nbre->Total); ?>)</small>
                </h5>
                <div class="panel-control">
                    <?php if(Privilege::canView(Privilege::$eshopProductAdd,$user->privilege)){ ?>
                        <a href="javascript:void(0);" data-toggle="tooltip" class="new" data-original-title="Nouveau personnel">
                    ...
                    <a href="<?= App::url('admins/personnel') ?>" data-toggle="tooltip" class="panel-reload" data-original-title="Rafraichir">
            ...
            <div class="panel-body">
                <div class="row m-t-sm">
                    <div class="col-md-12">
                        <form action="<?= App::url('admins/personnel') ?>" method="get">
                            <div class="row">
            ...
            <form action="<?= App::url('produits/save') ?>" id="newForm" method="post" enctype="multipart/form-data">
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 form-group">
                            <label for="slug"> Numero<b>*</b></label>
                            <input type="text" class="form-control" id="slug" name="slug" placeholder="numero" required>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 form-group">
                            <label for="slug">Adresse <b>*</b></label>
                            <input type="text" class="form-control" id="slug" name="slug" placeholder="adresse" required>
                        </div>
                        ...
                        <div class="col-md-4 form-group">
                            <label for="slug">Email <b>*</b></label>
                            <input type="text" class="form-control" id="slug" name="slug" placeholder="email" required>
                        </div>

                    </div>
                    <div class="row">
                        <div class="col-md-4 form-group">
                            <label for="slug">Fonction<b>*</b></label>
                            <input type="text" class="form-control" id="slug" name="slug" placeholder="fonction" required>
                        </div>
                    </div>
                </div>
