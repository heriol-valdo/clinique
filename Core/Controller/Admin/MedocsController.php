...
class MedocsController  extends AdminController {
    ...
    public function index(){
        ...
        $this->render('admin.medocs.index',compact('s_search','s_etat','s_sexe','s_role','s_debut','s_end','profils','user','nbre','nbrePages'));
    }
