...
class ConnexionController   extends AdminController {
    public function index(){
        ...
        $this->render('admin.connexion.index',compact('s_search','s_etat','s_sexe','s_role','s_debut','s_end','profils','user','nbre','nbrePages'));
    }
